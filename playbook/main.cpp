...
bool Init() {
	...
	if ( game == 0 ) {
		game = NewGame( 1024, 600, 0, playbookSavePath );
	}
...
void SendGUIEx( eMessageType type, float param1, float param2, int finger) {
	if ( game ) {
		...
		case MESSAGE_TYPE_GUI_CLICK_START:
			GameTap( game, MESSAGE_TYPE_GUI_CLICK_START, (int)param1, 600-(int)param2 );
			break;
		case MESSAGE_TYPE_GUI_CLICK_MOVE:
			GameTap( game, MESSAGE_TYPE_GUI_CLICK_MOVE, (int)param1, 600-(int)param2 );
			break;
		case MESSAGE_TYPE_GUI_CLICK_END:
			GameTap( game, MESSAGE_TYPE_GUI_CLICK_END, (int)param1, 600-(int)param2 );
			break;
		case MESSAGE_TYPE_GUI_CLICK_CANCEL:
			GameTap( game, MESSAGE_TYPE_GUI_CLICK_CANCEL, (int)param1, 600-(int)param2 );
			break;
